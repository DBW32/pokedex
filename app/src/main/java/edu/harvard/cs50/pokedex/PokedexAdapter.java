...
public class PokedexAdapter extends RecyclerView.Adapter<PokedexAdapter.PokedexViewHolder> implements Filterable {
    ...
    // Filtered list of Pokemon to preserve full list 'pokemon'
    ...
    // New class for filtered Pokemon search results
    private class PokemonFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            // Iterate through full list of Pokemon and store those containing 'constraint' in 'filteredPokemon'
        ...
        // Pass 'constraint' and instance of FilterResults from performFiltering to publishResults
        @Override
        protected void publishResults(CharSequence constraint, FilterResults results) {
            // Set filtered list to full list is search query is empty or starts with ' '
